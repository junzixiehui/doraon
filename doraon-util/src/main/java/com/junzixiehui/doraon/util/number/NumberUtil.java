...
public class NumberUtil {
	...
	public static int toInt(Object o) {
		return toInt(toString(o), -1);
	}

	public static int toInt(Object o, int def) {
		return toInt(toString(o), def);
	}
	...
	public static long toLong(Object o) {
		return toLong(toString(o), -1);
	}

	public static long toLong(Object o, long def) {
		return toLong(toString(o), def);
	}

	public static double toDouble(Object o) {
		return NumberUtils.toDouble(toString(o), -1);
	}

	public static double toDouble(Object o, double def) {
		return NumberUtils.toDouble(toString(o), def);
	}
	/**
